/** @template Data @template [Args={}] @typedef {(args: Args) => Promise<Data>} TaskFunction */
/** @template Data @typedef {{ loading: boolean, data: Data | undefined; error: Error | undefined }} TaskSnapshot */
...
export class Task {
  ...
  /** @type {TaskFunction<Data, Args>} */ #task;

  /** @type {boolean} */ loading = false;
  /** @type {Data | undefined} */ data = undefined;
  /** @type {Error | undefined} */ error = undefined;
